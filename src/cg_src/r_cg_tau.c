...
void R_TAU0_Create(void)
{
    ...
    TPS0 = _00_TAU_CKM0_FCLK_0 | _30_TAU_CKM1_FCLK_3;
    /* Stop all channels */
    ...
    TDR00H = _C3_TAU_TDR00H_VALUE;
    TDR00L = _4F_TAU_TDR00L_VALUE;
    ...
    /* Consecutive reading from the TDR0nH and TDR0nL registers and consecutive writing to the TDR0nH and TDR0nL
    registers must be performed in the state where an interrupt is disabled by the DI instruction. */
    TDR01H = _0E_TAU_TDR01H_VALUE;
    TDR01L = _29_TAU_TDR01L_VALUE;
    ...
    /* Consecutive reading from the TDR0nH and TDR0nL registers and consecutive writing to the TDR0nH and TDR0nL
    registers must be performed in the state where an interrupt is disabled by the DI instruction. */
    TDR02H = _09_TAU_TDR02H_VALUE;
    TDR02L = _C3_TAU_TDR02L_VALUE;
